//
//  PeekedPageScrollViewController.m
//  iCarousel
//
...
#import "PeekedPageScrollViewController.h"

@interface PeekedPageScrollViewController ()
...
@implementation PeekedPageScrollViewController
...
- (void) tapResponder: (UITapGestureRecognizer *) sender {
    ...
    UIViewController *quizViewController = (UIViewController *)[storyboard instantiateViewControllerWithIdentifier:@"quiz"];
